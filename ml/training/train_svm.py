"""
SVM training script for crop recommendation.
"""
import os
import pickle
...
def train_svm(dataset_path: str, models_dir: str):
    """
    Train SVM model for crop recommendation.
    ...
    """
    print("=" * 60)
    print("SVM TRAINING - CROP RECOMMENDATION")
    print("=" * 60)
    ...
    # Step 6: Train SVM
    print("Step 6: Training SVM (this may take a while)...")
    svm_model = SVC(
        kernel='rbf',
        C=10,
        gamma='scale',
...
if __name__ == "__main__":
    ...
    # Train model
    train_svm(dataset_path, models_dir)
